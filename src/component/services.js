              ...
              <Row className='d-flex justify-content-around'>
                      ...
                      <Card>
                          ...
                          <CardBody>
                            ...
                            <CardText>
                    گزینه افزایش اعتبار مخصوص مشترکین سیم کارت های دائمی و دیتا است و با انتخاب شماره نیترون و مبلغ شارژ دلخواه بدون نیاز به وارد کردن کد شارژ اعتبار ریالی در همان لحظه اعمال میگردد و فرایند کار راحت تر صورت خواهد گرفت.
                            </CardText>
                            <Button color="primary">
                              افزایش اعتبار
                            </Button>
